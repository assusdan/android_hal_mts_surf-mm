    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                #if 0 //#ifdef MTK_CAM_LOMO_SUPPORT
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_USER_LIST_(
                ...
                "(24000,24000)", 
                "(30000,30000)", 
#if 0 //#ifdef MTK_SLOW_MOTION_VIDEO_SUPPORT
                "(60000,60000)",
                "(120000,120000)",
#endif 
            )
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                MtkCameraParameters::CAPTURE_MODE_NORMAL, 
                   ...
                   #if 0 //#if (1 == MTK_MOTION_TRACK_SUPPORT)
...
else
{
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::CAPTURE_MODE_SMILE_SHOT, 
                MtkCameraParameters::CAPTURE_MODE_BEST_SHOT, 
                   #if 0 //#if (1 == MTK_CAM_AUTORAMA_SUPPORT)
                MtkCameraParameters::CAPTURE_MODE_AUTO_PANORAMA_SHOT,
                   #endif       
                   #if 0 //#if (1 == MTK_CAM_MAV_SUPPORT)
...
#if 1
    //	Video Hdr
#if 0 //#ifdef MTK_CAM_VHDR_SUPPORT
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
    ...
    //==========================================================================    
    //  Video Face Beauty
#if 0 //#ifdef MTK_CAM_VIDEO_FACEBEAUTY_SUPPORT
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
